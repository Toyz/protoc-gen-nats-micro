...
const file_user_v1_service_proto_rawDesc = "" +
	"\n" +
	"\x15user/v1/service.proto\x12\auser.v1\x1a\x17natsmicro/options.proto\"=\n" +
	...
	"\aGetUser\x12\x17.user.v1.GetUserRequest\x1a\x18.user.v1.GetUserResponse\x1a<\x8a\xb5\x188\n" +
	"\x06api.v1\x12\fuser_service\x1a\x051.0.0\"\x17User management service@\x01B\x15Z\x13example/gen/user/v1b\x06proto3"
...
var file_user_v1_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
